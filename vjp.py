...
def test_axpy():
    check(axpy, axpy_vjp, np.random.randn(13, 7), np.random.randn(7), np.random.randn(13))
...
def test_index():
    check(lambda x: index(x,3), lambda x,dret: index_vjp(x,3,dret), np.random.rand(13))
